    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        if (data.user.role === 'admin') {
          setError('Akses ditolak. Ini adalah portal pelanggan. Silakan gunakan portal admin.');
          localStorage.clear();
        } else {
          navigate('/customer');
        }
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '40px', boxShadow: '0 40px 80px rgba(0,0,0,0.3)' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '28px' }}>
              <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>Password</label>
              <div style={{ position: 'relative' }}>
